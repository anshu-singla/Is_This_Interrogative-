...
trainDec = open("RawTestingDataDeclarative.txt", encoding="utf8").read()
trainDec = nltk.sent_tokenize(trainDec)

testdecorg = open("RawTrainingDataDeclarative.txt", encoding="utf8").read()
testdecorg = nltk.sent_tokenize(testdecorg)
...
testDec = Sample_Answer + testdecorg
...
totalfeaturesets = trainfeaturesets + testfeaturesets
random.shuffle(totalfeaturesets)

trainfeaturesets = totalfeaturesets[:6500]
testfeaturesets = totalfeaturesets[6500:]
